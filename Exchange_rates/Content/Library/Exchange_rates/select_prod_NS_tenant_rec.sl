...
operation:
  name: select_prod_NS_tenant_rec
  inputs:
    - mf_username
    - mf_password:
        sensitive: true
  sequential_action:
    gav: 'com.microfocus.seq:Exchange_rates.select_prod_NS_tenant_rec:1.0.0'
    skills:
      - Java
      - SAP
      - SAP NWBC Desktop
    ...
    steps:
      ...
      - step:
          id: '5'
          object_path: 'Browser("Home - NetSuite (SANDBOX").Page("Home - NetSuite (SANDBOX").Link("Change Role Rpa User2")'
          action: Click
          snapshot: ".\\Snapshots\\ssf5.html"
          highlight_id: '10000000'
      - step:
          id: '6'
          object_path: 'Browser("Home - NetSuite (SANDBOX").Page("Choose Role - NetSuite").Link("Select Micro Focus GL")'
          action: Click
          snapshot: ".\\Snapshots\\ssf6.html"
          highlight_id: '10000000'
      - step:
          id: '7'
          object_path: 'Browser("Home - NetSuite (SANDBOX").Page("Home - NetSuite (Micro")'
          action: Sync
      - step:
          id: '8'
          ...
          - object:
              ...
              child_objects:
                - object:
                    ...
                    class: WebEdit
                    visual_relations: ''
                    last_update_time: 'Monday, January 13, 2020 7:22:55 AM'
        ...
        child_objects:
              ...
              child_objects:
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: Change Role Rpa User2 26006626-USSN SANDBOX - MF SB7 - PreProd - Micro Focus GL Accounting - MEC - All Subs
                            regular_expression: false
                          name: text
                          hidden: true
                          read_only: true
                      ...
                      - property:
                          value:
                            value: 'https://4542005-sb7.app.netsuite.com/app/center/myroles.nl'
                            regular_expression: false
                          name: href
                          hidden: true
                          read_only: true
          ...
          - object:
              ...
              properties:
                ...
                - property:
                    value:
                      value: 'https://4542005.app.netsuite.com/app/center/card.nl'
                      regular_expression: false
                    name: url without form data
                    hidden: true
                    read_only: true
                ...
                - property:
                    value:
                      value: 'https://4542005.app.netsuite.com/app/center/card.nl?sc=-29&whence='
                      regular_expression: false
                    name: url
                    hidden: true
                    read_only: true
          ...
          - object:
              ...
              child_objects:
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//TABLE[@id="div__bodytab"]/TBODY[1]/TR[2]/TD[2]/A[1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                      ...
                      - property:
                          value:
                            value: 'https://4542005-sb7.app.netsuite.com/app/login/secure/changerole.nl?id=246843939'
                            regular_expression: false
                          name: href
                          hidden: true
                          read_only: true
                      ...
                      - property:
                          value:
                            value: Select Micro Focus GL Accounting - MEC - All Subs - Micro Focus
                            regular_expression: false
                          name: acc_name
                          hidden: false
                          read_only: false
              ...
              properties:
                ...
                - property:
                    value:
                      value: 'https://4542005-sb7.app.netsuite.com/app/center/myroles.nl?redirect_count=1&did_javascript_redirect=T'
                      regular_expression: false
                    name: url
                    hidden: true
                    read_only: true
                ...
                - property:
                    value:
                      value: Choose Role - NetSuite (SANDBOX - MF SB7 - PreProd)
                      regular_expression: false
                    name: title
                    hidden: true
                    read_only: true
